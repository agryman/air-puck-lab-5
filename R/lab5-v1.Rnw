...
<<experiment1.sample, echo=FALSE, results=tex>>=
kable(head(experiment.1), format = "latex", caption = "Sample of Experiment 1 Tracker Data")
@
...
<<experiment2.sample, echo=FALSE, results=tex>>=
kable(head(experiment.2), format = "latex", caption = "Sample of Experiment 2 Tracker Data")
@
...
\begin{figure}[!h]
<<fig-exp-1xy, fig=TRUE, echo=FALSE>>=
ggplot(experiment.1.long, aes(x,y,colour=puck)) +
  geom_path() +
  geom_point()
@
...
\begin{figure}[!h]
<<fig-exp-1xt, fig=TRUE, echo=FALSE>>=
ggplot(experiment.1.long, aes(t,x,colour=puck)) +
  geom_line() +
  geom_point()
@
...
\begin{figure}[!h]
<<fig-exp-1yt, fig=TRUE, echo=FALSE>>=
ggplot(experiment.1.long, aes(t,y,colour=puck)) +
  geom_line() +
  geom_point()
@
...
\begin{figure}[!h]
<<fig-exp-1xsmooth, fig=TRUE, echo=FALSE>>=
ggplot(experiment.1.long, aes(x=t,y=x,colour=interaction(puck,state))) + 
geom_point() +
