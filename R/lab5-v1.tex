...
% v1: RStudio is not handling floatrow correctly.
% \begin{figure}[!h]
%    \begin{floatrow}
...
'data.frame':	24 obs. of  5 variables:
 $ t  : num  0 0.033 0.067 0.1 0.133 0.167 0.2 0.233 0.267 0.3 ...
 $ x.A: num  -0.282 -0.259 -0.227 -0.2 -0.175 -0.15 -0.128 -0.106 -0.078 -0.055 ...
 $ y.A: num  0.203 0.198 0.183 0.174 0.164 0.154 0.145 0.133 0.124 0.116 ...
 $ x.B: num  0.295 0.295 0.288 0.275 0.248 0.219 0.198 0.174 0.15 0.121 ...
 $ y.B: num  0.012 0.015 0.016 0.02 0.033 0.041 0.056 0.064 0.072 0.082 ...
\end{Soutput}
\end{Schunk}
...
'data.frame':	50 obs. of  5 variables:
 $ t  : num  0 0.033 0.067 0.1 0.133 0.167 0.2 0.233 0.267 0.3 ...
 $ x.A: num  -0.338 -0.315 -0.286 -0.262 -0.227 -0.202 -0.173 -0.136 -0.11 -0.079 ...
 $ y.A: num  0.257 0.245 0.243 0.236 0.234 0.227 0.222 0.216 0.215 0.21 ...
 $ x.B: num  0.315 0.314 0.317 0.314 0.304 0.276 0.229 0.192 0.149 0.111 ...
 $ y.B: num  0.087 0.092 0.096 0.094 0.097 0.101 0.108 0.115 0.12 0.127 ...
\end{Soutput}
\end{Schunk}
